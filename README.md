...
Al guardar, selecciona: a. Tipo de archivo: "Todos los archivos" b. Nombre: (como este en el repositorio).cpp c. Codificación: UTF-8
...
7.Compila el programa con: g++ (como lo guardaste).cpp -o (como lo guardaste).exe
...
g++ (como lo guardaste).cpp -o (como lo guardaste) 4.Ejecuta el programa con: ./(como lo guardaste)
...
Compila el archivo con g++: g++ (como lo guardaste).cpp -o (como lo guardaste)
